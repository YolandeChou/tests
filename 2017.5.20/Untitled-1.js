...
//1.数组定义
var data=[
	  {image:1,h2:"Inscure",h3:"HUSSLER"},
	  {image:2,h2:"Inscure",h3:"HUSSLER"},
	  {image:3,h2:"Inscure",h3:"HUSSLER"},
	  {image:4,h2:"Inscure",h3:"HUSSLER"},
	  {image:5,h2:"Inscure",h3:"HUSSLER"},
	  {image:6,h2:"Inscure",h3:"HUSSLER"},
	  {image:7,h2:"Inscure",h3:"HUSSLER"}
]
//2.通用函数
var g=function(id){
	if(id.substr(0,1)==".")
